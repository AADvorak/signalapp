<template>
  <div>
    ...
    <h2 class="desc-h2">Signal generation</h2>
    <div class="desc-div">Use <a href="/signal-generator">signal generator</a> to generate signals and import from txt and wav files.</div>
